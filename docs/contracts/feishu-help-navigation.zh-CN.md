...
- `/skills` 作用于当前目录可见的 skills 配置面
- `/plugins` 作用于当前目录可见的 plugins 配置与可见性面
- 第一阶段只支持 skills 启停、plugin 详情、已安装 plugin 启停
...
如果新增、删除、改名任何帮助页、按钮或表单入口，或改变 `compact / skills / plugins` 的帮助页归属，本文必须同步更新。
