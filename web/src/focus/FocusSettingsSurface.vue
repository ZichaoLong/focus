...
<template>
  <FocusSettingsDialog
    ...
    :update-operation-active="props.client.updateOperationActive.value"
    :update-actions-disabled="props.client.updateActionsDisabled.value"
    :update-status-stale="props.client.updateStatusStale.value"
    :update-notice="props.client.updateNotice.value"
    :update-observed-at="props.client.updateObservedAt.value"
